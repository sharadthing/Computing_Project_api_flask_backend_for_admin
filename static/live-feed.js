document.addEventListener('DOMContentLoaded', function () {
    ...
    const videoStreamUrl = 'http://192.168.0.30:5000/cam-rpi';
    ...
    const alcoholStreamUrl = 'http://192.168.0.30:5000/alcohol_trigger';

    function initAlcoholStream() {
      console.log('Initializing alcohol stream...');
      ...
      eventSource.onopen = () => {
        console.log('Alcohol stream connected');
    ...
    function updateAlcoholStatus(data) {
      ...
      if (match && match[1]) {
        ...
        if (alcoholLevel >= 20.0) {
          ...
          alcoholMessage.textContent = 'DANGER: High alcohol level detected!';
          ...
          alcoholMessage.textContent = 'Warning: Alcohol detected above safe levels';
          alcoholMessage.className = 'mt-3 p-2 rounded-lg text-sm bg-yellow-100 text-yellow-800';
          ...
          alcoholMessage.textContent = 'No alcohol detected';
